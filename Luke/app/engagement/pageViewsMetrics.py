...
from constants.importantDates import first_of_may_21, first_of_apr_21
...
def get_pw_stats_by_date_and_medium(start, end):
    ...
    medium_users_df = users_created_by_dates[users_created_by_dates['preferredMedium'] == 'app']
...
app_page_views_per_day_in_service = get_pw_stats_by_date_and_medium(start=first_of_apr_21, end=first_of_may_21)
...
unique_days_of_pws_first_week = get_unique_page_views_days_in_first_week(app_page_views_per_day_in_service)
