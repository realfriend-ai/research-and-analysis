...
from constants.importantDates import now, last_month, last_week
...
main_func(start=last_month, end=datetime.now())
...
enhancedProperties_df = find_enhanced_properties_in_the_last_week(start=last_month, end=datetime.now())
